...
var Sjqk = (_dec = (0, _mobxReact.inject)('kanbanStore'), _dec(_class = function (_React$Component) {
	_inherits(Sjqk, _React$Component);

	function Sjqk(props) {
		_classCallCheck(this, Sjqk);

		var _this = _possibleConstructorReturn(this, (Sjqk.__proto__ || Object.getPrototypeOf(Sjqk)).call(this, props));
   ...
   * */
		...
		value: function render() {
			...
			var columns = [{
				...
				title: '累计客户数',
				dataIndex: 'cumulation',
				align: 'center',
				className: 'vt'
			}];
			var option = {
				color: ['#47BAC1', '#7FC8EA', '#B5E3E5', '#A6E59F', '#A6E59F', '#59BFCB'],
				title: {
					text: '商机汇总',
					left: 'center',
					textStyle: {
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(_antd.Table, { columns: this.state.columns,
									...
									size: "small",
									showHeader: false,
									className: 'ci_table2 ci_table4 ci_table7 ci_table9',
									pagination: false,
									rowClassName: function rowClassName(record, index) {
										var className = index % 2 ? 'shallow_gray' : 'shallow_blue';
										return className;
...
exports.default = Sjqk;

/***/ })

});
//# sourceMappingURL=54-afa7d4b4bae6ff2924e9.1629092961041.js.map