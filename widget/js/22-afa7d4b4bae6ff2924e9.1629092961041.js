...
var _OfficeManageStore = __webpack_require__(747);

var _OfficeManageStore2 = _interopRequireDefault(_OfficeManageStore);
...
var OfficeManage = (_dec = (0, _mobxReact.inject)('OfficeManageStore'), _dec2 = (0, _mobxReact.inject)('DigtalOrgStore'), _dec(_class = _dec2(_class = (0, _mobxReact.observer)(_class = function (_React$Component) {
	_inherits(OfficeManage, _React$Component);

	function OfficeManage(props) {
		_classCallCheck(this, OfficeManage);

		var _this2 = _possibleConstructorReturn(this, (OfficeManage.__proto__ || Object.getPrototypeOf(OfficeManage)).call(this, props));
		...
		_this2.handleRoute = function () {
			_this2.props.DigtalOrgStore.digtalKey = "5";
			_this2.props.history.push("/digital/office");
		};

		_this2.handleDraftRoute = function () {
			_this2.props.DigtalOrgStore.digtalKey = "5";
			_this2.props.history.push("/digital/office/draft");
		};
	...
	_createClass(OfficeManage, [{
		...
		value: function componentDidMount() {
			...
			this.store.getSts();
			// 时间监听
			_this.emitter = _events2.default.addListener('journal', function () {
				_this.getTable();
			});
		...
		value: function componentWillMount() {
			if (this.emitter) {
				_events2.default.removeListener(this.emitter);
			}
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ className: 'fl', style: { width: 'calc(100% - 350px)', borderLeft: '1px solid #EBEBEB', minHeight: '350px', paddingLeft: '15px', overflowY: 'scroll', height: "calc(100vh - 180px)" } },
					temType === "weekreport" ? mobx.toJS(maintableData).length == 0 ? _react2.default.createElement(_antd.Empty, { imageStyle: { marginTop: "50px" } }) : _react2.default.createElement(_DetailFormWeekReport2.default, {
						store: this.store,
					...
					temType === "factoryreport" ? mobx.toJS(maintableData).length == 0 ? _react2.default.createElement(_antd.Empty, { imageStyle: { marginTop: "50px" } }) : _react2.default.createElement(_DetailFormFactoryreport2.default, {
						store: this.store,
						detailData: mobx.toJS(deData),
						onAsync: this.onAsync,
						hasJournal: hasJournal,
...
//# sourceMappingURL=22-afa7d4b4bae6ff2924e9.1629092961041.js.map