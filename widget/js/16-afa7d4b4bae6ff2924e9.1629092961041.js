...
var _ProjectMgr = __webpack_require__(1786);

var _ProjectMgr2 = _interopRequireDefault(_ProjectMgr);
...
var DeliveryProList = (_dec = (0, _mobxReact.inject)('DeliveryStore'), _dec(_class = (0, _reactRouterDom.withRouter)(_class = (0, _mobxReact.observer)(_class = function (_React$Component) {
	_inherits(DeliveryProList, _React$Component);

	function DeliveryProList(props) {
		_classCallCheck(this, DeliveryProList);

		var _this = _possibleConstructorReturn(this, (DeliveryProList.__proto__ || Object.getPrototypeOf(DeliveryProList)).call(this, props));
	...
	_createClass(DeliveryProList, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'div',
				null,
				_react2.default.createElement(_ProjectMgr2.default, {
					store: this.store
				})
			);
		}
...
exports.default = DeliveryProList;
...
var _DeliveryProList = __webpack_require__(1461);

var _DeliveryProList2 = _interopRequireDefault(_DeliveryProList);
...
var Delivery = (_dec = (0, _mobxReact.inject)('DeliveryStore'), _dec(_class = (0, _reactRouterDom.withRouter)(_class = (0, _mobxReact.observer)(_class = function (_React$Component) {
	...
	function Delivery(props) {
		...
		_this.onSearch = function (value) {
			// this.store.getProjectPageList(value);
			if (_this.state.activeKey === "1") {
				_this.getOnGoingProject2(value);
			} else {
				_this.getOnGoingProject3(value);
			}
		};

		_this.checkboxOnChange = function (e) {
			_this.store.params2.pageIndex = 1;
			_this.store.params3.pageIndex = 1;
			if (_this.state.activeKey === "1") {
				if (e.target.checked) {
					_this.store.params2.userId = localStorage.getItem('userid');
				} else {
					_this.store.params2.userId = "";
				}
				_this.getOnGoingProject2("");
			} else {
				if (e.target.checked) {
					_this.store.params3.userId = localStorage.getItem('userid');
				} else {
					_this.store.params3.userId = "";
				}
				_this.getOnGoingProject3("");
			}
		};

		_this.goToKeyLink = function (url) {
		...
		_this.searchAndMgr = _react2.default.createElement(
			...
			_react2.default.createElement(
				'div',
				{ style: { cursor: "pointer" }, onClick: _this.handleCreate, className: 'ml15 dib' },
				_react2.default.createElement(_antd.Icon, { type: 'setting' }),
				_react2.default.createElement(
					'span',
					{ style: { cursor: "pointer" }, className: 'ml5' },
					'\u7BA1\u7406\u9879\u76EE'
				)
			)
		);

		_this.getOnGoingProject2 = function (text) {
			_this.store.getProjectPageList2(text);
		};

		_this.getOnGoingProject3 = function (text) {
			_this.store.getProjectPageList3(text);
		};
				...
				return regeneratorRuntime.wrap(function _callee$(_context) {
					while (1) {
						switch (_context.prev = _context.next) {
							case 0:
								_this.store.params2.pageIndex = 1;
								_this.store.params2.pageSize = pageSize;
								_this.getOnGoingProject2('');
				...
				return regeneratorRuntime.wrap(function _callee2$(_context2) {
					while (1) {
						switch (_context2.prev = _context2.next) {
							case 0:
								_this.store.params2.pageIndex = pageNumber;
								if (pageNumber > 1) _this.store.params2.pageSize = 20;
								if (pageNumber === 1) _this.store.params2.pageSize = 19;
								_this.getOnGoingProject2('');
		...
		_this.showSizeChange3 = function () {
				...
				return regeneratorRuntime.wrap(function _callee3$(_context3) {
					while (1) {
						switch (_context3.prev = _context3.next) {
							case 0:
								_this.store.params3.pageIndex = 1;
								_this.store.params3.pageSize = pageSize;
								_this.getOnGoingProject3('');
		...
		_this.onPageChange3 = function () {
			var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(pageNumber) {
				return regeneratorRuntime.wrap(function _callee4$(_context4) {
					while (1) {
						switch (_context4.prev = _context4.next) {
							case 0:
								_this.store.params3.pageIndex = pageNumber;
								if (pageNumber > 1) _this.store.params3.pageSize = 20;
								if (pageNumber === 1) _this.store.params3.pageSize = 19;
								_this.getOnGoingProject3('');
		...
		_this.showTotal3 = function (total) {
			return '\u5171 ' + total + ' \u6761';
		};

		_this.getProjectPurpose = function (str) {
			var arr = str === null ? "" : str.substr(1, str.length - 2);
	...
	_createClass(Delivery, [{
		...
		value: function componentDidMount() {
			...
			var key = _url2.default.parse(search, true).query.key;
			this.loadPageInfo();
			this.store.isProjectitem = false;
		}
	}, {
		key: 'render',
		value: function render() {
			...
			var _store = this.store,
			    projectList2 = _store.projectList2,
			    params2 = _store.params2,
			    projectTotalCount2 = _store.projectTotalCount2,
			    projectList3 = _store.projectList3,
			    params3 = _store.params3,
			    projectTotalCount3 = _store.projectTotalCount3,
			    isProjectitem = _store.isProjectitem;

			var _mobx$toJS = mobx.toJS(params2),
			    pageIndex = _mobx$toJS.pageIndex,
			    pageSize = _mobx$toJS.pageSize;
			//const operations = <div><Button style={{cursor:'pointer'}} type="link" onClick={this.handleCreate}>项目管理</Button></div>;


			return _react2.default.createElement(
				'div',
				{ className: 'w h' },
				isProjectitem == false || isProjectitem == null ? _react2.default.createElement(
					_antd.Tabs,
					{ defaultActiveKey: '1', activeKey: activeKey, onChange: this.callback, tabBarExtraContent: this.searchAndMgr },
					_react2.default.createElement(
						TabPane,
						{ tab: '\u8FDB\u884C\u4E2D', key: '1' },
						_react2.default.createElement(
							'span',
							{ style: { display: '' } },
							_react2.default.createElement(_antd.Checkbox, { onChange: this.checkboxOnChange }),
							_react2.default.createElement(
								'span',
						...
						_react2.default.createElement(
							'div',
							{ className: 'img-list-delivery' },
							_react2.default.createElement(
								'ul',
								null,
								projectList2.map(function (item, index) {
									if (index === 0 && pageIndex === 1) {
										return _react2.default.createElement(
											...
											_react2.default.createElement(
												'li',
												{ key: index, className: 'newProject' },
												_react2.default.createElement(
													'div',
													{ onClick: function onClick() {
															_this3.goToLink('/delivery/newproject');
													...
													_react2.default.createElement(
														...
														_react2.default.createElement(
															...
															_react2.default.createElement(
																_antd.Button,
																{ type: 'dashed', className: 'newButton' },
											...
											_react2.default.createElement(
												...
												_react2.default.createElement(
													'div',
													{ onClick: function onClick() {
															_this3.goToKeyLink('/delivery/keylink?projectId=' + item.id);
														}, style: { cursor: 'pointer' } },
													_react2.default.createElement(
														'div',
														{ className: 'imgWrap' },
														_react2.default.createElement(
															'div',
															{ className: 'imgBox' },
															_react2.default.createElement('img', { src: item.mainPhoto === null ? 'https://xinlj.oss-cn-beijing.aliyuncs.com/mainphoto/hrwxf.jpg' : item.mainPhoto })
														)
													),
													_react2.default.createElement(
														'div',
												...
												_react2.default.createElement(
													...
													_react2.default.createElement(
														'div',
														{ className: 'project_name', title: item.name },
														item.name
													),
													_react2.default.createElement(
														'div',
														...
														_react2.default.createElement(
															'div',
															{ className: 'long_name', title: item.companyName },
															'\u7532\u65B9\u5355\u4F4D\uFF1A',
															item.companyName == "" || item.companyName == null ? "未确定" : item.companyName
														),
														_react2.default.createElement(
															'div',
															null,
														...
														_react2.default.createElement(
															'div',
															{ className: 'long_name', title: item.purpose == null || item.purpose == "" ? "未确定" : item.purpose },
															'\u9879\u76EE\u7528\u9014\uFF1A',
															item.purpose == null || item.purpose == "" ? "未确定" : item.purpose
														),
														_react2.default.createElement(
															'div',
															null,
															'\u5F00\u5DE5\u65E5\u671F\uFF1A',
															item.tempBuildBeginTime == 0 || item.tempBuildBeginTime == null ? "未确定" : (0, _moment2.default)(item.tempBuildBeginTime).format("YYYY-MM-DD")
														)
													)
												)
											)
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'ul',
								null,
								projectList3.map(function (item, index) {
									return _react2.default.createElement(
										'li',
										{ key: index },
										_react2.default.createElement(
										...
										_react2.default.createElement(
											...
											_react2.default.createElement(
												...
												_react2.default.createElement(
													'div',
													{ className: 'long_name', title: item.partyUnits },
													'\u7532\u65B9\u5355\u4F4D\uFF1A',
													item.partyUnits
												),
												_react2.default.createElement(
												...
												_react2.default.createElement(
													'div',
													{ className: 'long_name', title: _this3.getProjectPurpose(item.purpose) },
													'\u9879\u76EE\u7528\u9014\uFF1A',
													_this3.getProjectPurpose(item.purpose)
												),
												_react2.default.createElement(
													'div',
													null,
													'\u5F00\u5DE5\u65E5\u671F\uFF1A',
													item.tempBuildBeginTime !== 0 ? (0, _moment2.default)(item.tempBuildBeginTime).format("YYYY-MM-DD") : ""
												)
											)
										)
									);
						...
						_react2.default.createElement(_antd.Pagination, {
							className: 'mt20 tr',
							current: mobx.toJS(params3.pageIndex),
							pageSize: mobx.toJS(params3.pageSize),
							total: projectTotalCount3,
							onShowSizeChange: this.showSizeChange3,
							onChange: this.onPageChange3,
							showSizeChanger: true,
							showQuickJumper: true,
							showTotal: this.showTotal3
						})
					)
				) : null,
				isProjectitem ? _react2.default.createElement(_DeliveryProList2.default, null) : null
			);
		}
	}]);
...
var PageSelect = (_dec = (0, _mobxReact.inject)('DeliveryStore'), _dec(_class = (0, _mobxReact.observer)(_class = function (_React$Component) {
	_inherits(PageSelect, _React$Component);

	function PageSelect(props) {
		_classCallCheck(this, PageSelect);

		var _this = _possibleConstructorReturn(this, (PageSelect.__proto__ || Object.getPrototypeOf(PageSelect)).call(this, props));
		...
		_this.companyScroll = function (e) {
			...
			if (target.scrollTop + target.offsetHeight === target.scrollHeight) {
				...
				_this.setState({
					...
					_this.store.getCompanyPageList(params).then(function (res) {
						if (res) {
							_this.setState({
	...
	_createClass(PageSelect, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				_antd.Select,
				{
					style: { width: style != undefined ? style : '100%' },
					showSearch: true,
					placeholder: '\u8BF7\u9009\u62E9',
...
var EditableTableSubProject = (0, _mobxReact.observer)(_class2 = function (_React$Component2) {
	_inherits(EditableTableSubProject, _React$Component2);

	function EditableTableSubProject(props) {
		_classCallCheck(this, EditableTableSubProject);

		var _this3 = _possibleConstructorReturn(this, (EditableTableSubProject.__proto__ || Object.getPrototypeOf(EditableTableSubProject)).call(this, props));
	...
	_createClass(EditableTableSubProject, [{
		key: 'componentWillReceiveProps',
		value: function componentWillReceiveProps(nextProps, nextContext) {
	...
	return EditableTableSubProject;
}(_react2.default.Component)) || _class2;

exports.default = EditableTableSubProject;
...
var PersonAddIcon = (_dec = (0, _mobxReact.inject)('UserStore'), _dec(_class = (0, _mobxReact.observer)(_class = function (_React$Component) {
    _inherits(PersonAddIcon, _React$Component);

    function PersonAddIcon(props) {
        _classCallCheck(this, PersonAddIcon);

        var _this = _possibleConstructorReturn(this, (PersonAddIcon.__proto__ || Object.getPrototypeOf(PersonAddIcon)).call(this, props));

        _this.init = function () {
            var defaultData = JSON.parse(JSON.stringify(_this.state.defaultData));
            //  将已选定的用户做标记
            var arr = defaultData.map(function (item) {
                var obj = {};
                if ([].concat(_toConsumableArray(_this.state.oldSelect)).some(function (v) {
                    return v.userId === item.id;
                })) {
        ...
        _this.handClick = function (param) {
            ...
            var dindex = dataArray.map(function (item) {
                return Object.assign(item, { selected: false });
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                { style: { position: 'relative',
                        ...
                        padding: '0px 3px' } },
                oldSelect.length > 0 ? oldSelect.map(function (item, index) {
                    return _react2.default.createElement(
                        'span',
                        { className: '' },
                        _react2.default.createElement(
                            'span',
                            {
                                style: { padding: disabled ? "0 5px" : "0 15px  0 5px" },
...
var _PersonAddIcon = __webpack_require__(1616);

var _PersonAddIcon2 = _interopRequireDefault(_PersonAddIcon);

var _EditableTableSubProject = __webpack_require__(1615);

var _EditableTableSubProject2 = _interopRequireDefault(_EditableTableSubProject);
...
var _PageSelect = __webpack_require__(1614);
...
var Option = _antd.Select.Option;
var EditProject = (_dec = (0, _mobxReact.inject)('DeliveryStore'), _dec2 = _antd.Form.create(), _dec(_class = (0, _reactRouterDom.withRouter)(_class = _dec2(_class = (0, _mobxReact.observer)(_class = function (_React$Component) {
	...
	function EditProject(props) {
		...
		_this.handleAttment = function (type, params) {
			...
			_this.setState({ attachments: arr });
			var projectObj = _this.store.projectObj;

			_this.store.projectObj = Object.assign(projectObj, { "mainPhoto": params[0]['filePath'] });
		};

		_this.handleBack = function () {
			_this.props.history.push("/order?key=1");
		};

		_this.transTxt = function (fields) {
			var logoName = void 0;
		...
		_this.updatePerson = function (userIds) {
			var projectObj = _this.store.projectObj;

			if (userIds.length > 0) {
				_this.props.form.setFieldsValue({
					"masterName": userIds[0]['userName']
				});
				_this.store.projectObj = Object.assign(mobx.toJS(projectObj), { "masterId": userIds[0]['userId'], "masterName": userIds[0]['userName'], "masters": userIds });
			}
		};

		_this.saveContents = function (dataSource) {
			_this.setState({ subProjects: dataSource });
		};

		_this.setCreateStep = function (step) {
			_this.setState({ createStep: step });
		};
		...
		_this.updateProject = function () {
			...
			_this.props.form.validateFields(function (err, values) {
				if (!err) {
					delete values.name;
					var newObj = Object.assign(mobx.toJS(projectObj), values, {
						"beginTime": values['beginTime'] === '' ? null : values['beginTime'].valueOf(),
						"endTime": values['endTime'] === '' ? null : values['endTime'].valueOf(),
						// "tempBuildBeginTime":values['tempBuildBeginTime']===''?null:values['tempBuildBeginTime'].valueOf(),
						//"tempBuildEndTime":values['tempBuildEndTime']===''?null:values['tempBuildEndTime'].valueOf(),
						"masterName": projectObj.masterName,
						"masterId": projectObj.masterId });

					var masters = newObj.masters,
					    newProject = _objectWithoutProperties(newObj, ['masters']);

					var parmas = { "p": Object.assign({}, newProject) };
					_this.store.updateProject(parmas).then(function (res) {
						if (res) {
		...
		_this.onSearchAddress = function (param) {
			fetch('https://restapi.amap.com/v3/geocode/geo?key=08cde7c6ec084c2b876f82636820b573&address=' + param, {
				method: 'GET'
			}).then(function (res) {
				if (res.ok) {
					res.json().then(function (data) {
						...
						_this.store.projectObj = Object.assign(mobx.toJS(_this.store.projectObj), {
			...
			var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(type, value) {
				...
				return regeneratorRuntime.wrap(function _callee$(_context) {
					while (1) {
						switch (_context.prev = _context.next) {
							case 0:
								_this.store.projectObj[type] = Object.assign([], value);
								//console.log(value, value.join(""), '地区')
								if (value && value.length) {
									param = value.join("");
									// 获取经纬度

									_this.onSearchAddress(param);
								}
		...
		_this.handleChangeSelect = function (value) {
			_this.setState({ projectPurpose: value });
		};
		...
		_this.updateStore = function (param) {
			...
			_this.store.projectObj = Object.assign(mobx.toJS(_this.store.projectObj), {
				companyId: param.id,
				partyUnits: param.name
			});
		};

		_this.handleChangeInput = function (type, e) {
			var val = e.target.value;
			_this.store.projectObj = Object.assign(mobx.toJS(_this.store.projectObj), _defineProperty({}, type, val));
		};

		_this.handleChangeInput2 = function (type, value) {
			var val = value;
			_this.store.projectObj = Object.assign(mobx.toJS(_this.store.projectObj), _defineProperty({}, type, val));
		};
	...
	_createClass(EditProject, [{
		...
		value: function componentWillReceiveProps(nextProps, nextContext) {
			if (nextProps.location.search !== this.props.location.search) {
				...
				var projectObj = this.store.projectObj;

				var fields = mobx.toJS(projectObj);

				this.setState({
					attachments: fields.mainPhoto == null ? [] : [{
						id: fields.id,
						uid: fields.id,
						name: fields.name,
						status: 'done',
						url: fields.mainPhoto,
						filePath: fields.mainPhoto,
						fileId: fields.id,
		...
		value: function componentDidMount() {
			...
			this.store.getProjectTypeList().then(function (res) {
				if (res) {
					_this3.setState({
						projectTypes: res
					});
		...
		value: function render() {
			var _state = this.state,
			    ...
			    projectPurpose = _state.projectPurpose,
			    projectTypes = _state.projectTypes;
			var _store = this.store,
			    ossData = _store.ossData,
			    projectObj = _store.projectObj;
			...
			var fields = mobx.toJS(projectObj); // 基本信息
			...
			return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									...
									_react2.default.createElement(
										...
										_react2.default.createElement(
											...
											getFieldDecorator('name', {
												...
												'div',
												null,
												_react2.default.createElement(_antd.Input, { value: fields.namePartyAShort, onChange: this.handleChangeInput.bind(this, "namePartyAShort"), placeholder: '\u7532\u65B9\u7B80\u79F0', style: { width: "80px", padding: "4" } }),
												_react2.default.createElement(_antd.Input, { value: fields.namePlace, onChange: this.handleChangeInput.bind(this, "namePlace"), placeholder: '\u9879\u76EE\u5730\u70B9', style: { width: "80px", margin: "0 2px", padding: "4" } }),
												_react2.default.createElement(_antd.Input, { value: fields.nameProjectShort, onChange: this.handleChangeInput.bind(this, "nameProjectShort"), placeholder: '\u5DE5\u7A0B\u7B80\u79F0', style: { width: "80px", padding: "4" } }),
												_react2.default.createElement(
													_antd.Select,
													{ value: fields.nameType == 0 ? "" : fields.nameType,
														onChange: this.handleChangeInput2.bind(this, "nameType"),
														placeholder: '类型',
									...
									_react2.default.createElement(
										...
										_react2.default.createElement(
											_antd.Form.Item,
											{ label: '\u9879\u76EE\u7ECF\u7406', className: 'w detail_form_person', style: { width: '100%', height: '40px' } },
											getFieldDecorator('masterName', {
												initialValue: fields.masterName || "",
									...
									_react2.default.createElement(
										...
										_react2.default.createElement(
											...
											getFieldDecorator('region', {
												initialValue: this.convertStrToArr(fields.region),
												rules: [{ required: true, message: '此项是必填' }]
											})(_react2.default.createElement(_antd.Cascader, {
												placeholder: '\u7701/\u5E02/\u533A(\u53BF)',
												showSearch: this.filter,
												options: _cityData2.default,
												value: fields.region == null ? [] : this.convertStrToArr(fields.region),
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									_antd.Row,
									{ gutter: [{ xs: 24, sm: 24, md: 24, lg: 24, xl: 24 }, 15], style: { padding: 0, margin: "0" } },
									_react2.default.createElement(
										_antd.Col,
										...
										_react2.default.createElement(
											...
											getFieldDecorator('mainPhoto', {
												initialValue: fields.mainPhoto,
												rules: [{
													required: false,
													message: '此项是必填' }]
											})(_react2.default.createElement(_MyUpload2.default, {
												key: 'mainPhoto',
												saveAttachment: this.handleAttment.bind(this, 'mainPhoto'),
												disabled: hidden,
												multiple: true,
				...
				_react2.default.createElement(
					'div',
					{ className: 'clearfix mt30', style: { display: 'flex', justifyContent: 'center' } },
					_react2.default.createElement(
						_antd.Button,
						{ onClick: this.props.onCancel, type: 'default' },
						'\u53D6\u6D88'
					),
					_react2.default.createElement(
						_antd.Button,
						{ onClick: this.updateProject, type: 'primary', className: 'ml20' },
						'\u4FDD\u5B58'
					)
				)
			);
...
var MyUploadNew2 = (_dec = (0, _mobxReact.inject)('appStore'), _dec(_class = (0, _mobxReact.observer)(_class = function (_React$Component) {
	_inherits(MyUploadNew2, _React$Component);

	function MyUploadNew2(props) {
		var _this2 = this;

		_classCallCheck(this, MyUploadNew2);

		var _this = _possibleConstructorReturn(this, (MyUploadNew2.__proto__ || Object.getPrototypeOf(MyUploadNew2)).call(this, props));
...
var _EditProject = __webpack_require__(1783);

var _EditProject2 = _interopRequireDefault(_EditProject);

var _MyUploadNew = __webpack_require__(1785);
...
var ProjectMgr = (0, _reactRouterDom.withRouter)(_class = (0, _mobxReact.observer)(_class = function (_React$Component) {
	_inherits(ProjectMgr, _React$Component);

	function ProjectMgr(props) {
		var _this2 = this;

		_classCallCheck(this, ProjectMgr);

		var _this = _possibleConstructorReturn(this, (ProjectMgr.__proto__ || Object.getPrototypeOf(ProjectMgr)).call(this, props));
			...
			var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(current, pageSize) {
				return regeneratorRuntime.wrap(function _callee$(_context) {
					while (1) {
						switch (_context.prev = _context.next) {
							case 0:
								_this.store.params.pageIndex = 1;
								_this.store.params.pageSize = pageSize;
								_this.getProjectPageList('');
			...
			var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(pageNumber) {
				return regeneratorRuntime.wrap(function _callee2$(_context2) {
					while (1) {
						switch (_context2.prev = _context2.next) {
							case 0:
								_this.store.params.pageIndex = pageNumber;
								_this.getProjectPageList('');
		...
		_this.getProjectPageList = function (text) {
			_this.store.getProjectPageList(text);
		};
		...
		_this.getStateInfo = function (state) {
			if (state === 0) {
				return "进行中";
			}
			if (state === 1) {
		...
		_this.showEditProjectModal = function (id) {
			_this.store.getProjectById({ "id": id }).then(function (res) {
				if (res) {
					_this.store.projectObj = Object.assign({}, res, {
						"masters": [{
							"userId": res.masterId,
							"userName": res.masterName
						}]
					});
					return true;
				}
				...
				if (res) {
					_this.setState({ editVisible: true });
				}
			});
		};

		_this.handleSerach = function (value) {
			_this.store.params.pageIndex = 1;
			_this.getProjectPageList(value);
		};
		...
		_this.handleAttment = function (arr, record) {
			...
			var newObj = Object.assign(record, { "mainPhoto": _this.convertHttp2Https(arr[0]['fileUrl']) });

			var masters = newObj.masters,
			    keyIndex = newObj.keyIndex,
			    p = _objectWithoutProperties(newObj, ['masters', 'keyIndex']);

			var params = { "p": p };
			_this.store.updateProject(params).then(function (res) {
				if (res) {
					_this.getProjectPageList('');
				}
			});
		...
		_this.handleProjectState = function (key, record) {
			var newObj = Object.assign(record, { "state": parseInt(key.key) });
		...
		_this.projectStateMenu = function (record) {
			return _react2.default.createElement(
				_antd.Menu,
				{ onClick: function onClick(key) {
						_this.handleProjectState(key, record);
					} },
				_react2.default.createElement(
					_antd.Menu.Item,
					{ style: record['state'] === 0 ? {
							display: 'flex',
							justifyContent: 'space-between',
							alignItems: 'center'
						} : { display: 'flex', justifyContent: 'flex-end' }, key: 0 },
					record['state'] === 0 ? _react2.default.createElement(_antd.Icon, { type: 'check' }) : null,
					_react2.default.createElement(
						_antd.Button,
						{ type: 'link' },
						'\u8FDB\u884C\u4E2D'
				...
				_react2.default.createElement(
					...
					{ style: record['state'] === 1 ? {
							...
							justifyContent: 'space-between',
							alignItems: 'center'
						} : { display: 'flex', justifyContent: 'flex-end' }, key: 1 },
					record['state'] === 1 ? _react2.default.createElement(_antd.Icon, { type: 'check' }) : null,
					_react2.default.createElement(
						_antd.Button,
						{ type: 'link' },
						'\u5DF2\u5B8C\u6210'
		...
		_this.handleBack = function () {
			_this.store.isProjectitem = false;
		};
	...
	_createClass(ProjectMgr, [{
		...
		value: function render() {
			...
			var _store = this.store,
			    ...
			    projectTotalCount = _store.projectTotalCount,
			    params = _store.params,
			    projectsloading = _store.projectsloading,
			    ossData = _store.ossData;
			...
			var columns = [{ title: '序号', dataIndex: 'keyIndex', align: 'center', width: '50px' }, {
				title: '状态', dataIndex: 'state', align: 'left', width: '80px', render: function render(text, record) {
					return _react2.default.createElement(
						'span',
						null,
						_this3.getStateInfo(text)
					);
				}
			}, {
				title: '项目', className: 'vt', dataIndex: 'name', align: 'left', render: function render(text, record) {
					return _react2.default.createElement(
						'div',
						{ onClick: function onClick() {
								_this3.goToKeyLink('/delivery/keylink?projectId=' + record['id']);
							},
							style: {
								display: "flex",
						...
						_react2.default.createElement('img', { width: 120, height: 63,
							src: record.mainPhoto === null ? 'https://xinlj.oss-cn-beijing.aliyuncs.com/mainphoto/hrwxf.jpg' : record.mainPhoto }),
						_react2.default.createElement(
							'span',
			...
			}, { title: '项目编号', dataIndex: 'number', align: 'center', width: '100px' }, {
				title: '创建日期', dataIndex: 'createTime', align: 'center', width: '100px', render: function render(text, record) {
					return text === 0 ? "" : (0, _moment2.default)(text).format("YYYY-MM-DD");
				}
			}, { title: '创建人', dataIndex: 'createUserName', align: 'center' }, {
				title: '项目负责人', dataIndex: 'masterName', align: 'center', width: '100px',
				render: function render(text, record) {
					return _react2.default.createElement(
						'div',
						{ style: {
				...
				title: '操作', dataIndex: 'caozuo', className: 'vt', align: 'center', render: function render(text, record) {
					return _react2.default.createElement(
						'div',
						null,
						_react2.default.createElement(
							...
							_react2.default.createElement(
								_antd.Button,
								{ onClick: function onClick() {
										_this3.showEditProjectModal(record.id);
									}, type: 'link' },
								' \u7F16\u8F91\u9879\u76EE'
							),
							_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(_MyUploadNew2.default, {
								saveAttachment: function saveAttachment(arr) {
									_this3.handleAttment(arr, record);
								},
								disabled: false,
								multiple: true,
								listType: 'text',
							...
							_react2.default.createElement(
								_antd.Dropdown,
								{ overlay: _this3.projectStateMenu(record) },
								_react2.default.createElement(
									_antd.Button,
									{ className: 'pr', type: 'link' },
									'\u4FEE\u6539\u72B6\u6001',
									_react2.default.createElement(_antd.Icon, {
			...
			var _mobx$toJS = mobx.toJS(params),
			    pageIndex = _mobx$toJS.pageIndex,
			    pageSize = _mobx$toJS.pageSize;
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ className: 'mt15' },
					_react2.default.createElement(_antd.Icon, { type: 'left', style: { color: "#57ACFF" } }),
					_react2.default.createElement(
						_antd.Button,
						{ style: { padding: "5px" }, type: 'link', onClick: this.handleBack },
						'\u8FD4\u56DE\u9879\u76EE\u9996\u9875'
					)
				),
				_react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(_antd.Table, {
						...
						, dataSource: mobx.toJS(projectList).map(function (item, index) {
							return Object.assign(item, { 'keyIndex': (pageIndex - 1) * pageSize + index + 1 });
						}),
						size: 'middle',
				...
				_react2.default.createElement(
					_antd.Modal,
					{
						...
						footer: null,
						className: 'task_detail_modal',
						style: { width: "70%", minWidth: "1000px" },
						destroyOnClose: true
					},
					_react2.default.createElement(_EditProject2.default, { onCancel: this.handleCloseEdit })
				)
			);
		}
	}]);
...
exports.default = ProjectMgr;

/***/ })

});
//# sourceMappingURL=16-afa7d4b4bae6ff2924e9.1629092961041.js.map