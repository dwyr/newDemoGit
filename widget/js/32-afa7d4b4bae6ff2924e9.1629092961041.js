...
//import TechnologicalMethod from "@/components/construction/TechnologicalMethod";
...
var _AddOrEdit = __webpack_require__(1995);

var _AddOrEdit2 = _interopRequireDefault(_AddOrEdit);
...
var Construction = (0, _mobxReact.observer)(_class = function (_React$Component) {
  _inherits(Construction, _React$Component);
  ...
  function Construction(props) {
    ...
    var _this2 = _possibleConstructorReturn(this, (Construction.__proto__ || Object.getPrototypeOf(Construction)).call(this, props));

    _this2.getTableData = function () {
      _this2.setState({ loading: true });
      (0, _api.requestPost)('getProjectList', _config2.default.construction.getProjectList, _construction2.default.construction.getProjectList, {
        text: "",
        ...
        if (Array.isArray(data.body) && data.body.length > 0) {
          ...
          _this2.store.pageIndex = data.pageIndex;
          _this2.store.pageSize = data.pageSize;
    ...
    _this2.showDeleteConfirm = function () {
      ...
      confirm({
        ...
        cancelText: '取消',
        onOk: function onOk() {
          (0, _api.requestPost)('delProject', _config2.default.construction.delProject, _construction2.default.construction.delProject, {
    ...
    _this2.handleAdd = function () {
      // 新建项目
      (0, _api.requestPost)('addProject', _config2.default.construction.addProject, _construction2.default.construction.addProject, {}).then(function (res) {
        _this2.store.projectField = Object.assign({}, res, {
    ...
    _this2.handleEdit = function (item) {
      var _this = _this2;
      (0, _api.requestPost)('getProject', _config2.default.construction.getProject, _construction2.default.construction.getProject, {
        projectId: item
      }).then(function (res) {
        _this.store.buildUnits = res.buildUnits.orgUser == null ? [] : res.buildUnits.orgUser;
        _this.store.supervisionUnits = res.supervisionUnits.orgUser == null ? [] : res.supervisionUnits.orgUser;
        _this.store.constructionUnits = res.constructionUnits.orgUser == null ? [] : res.constructionUnits.orgUser;
        var sub = res.subcontractors == null ? [] : res.subcontractors;
        _this.store.projectField = Object.assign(res, { subcontractors: sub }, { positions: res.positions == null ? [] : res.positions });
        //{state: this.convertState2String(res.state)}
        _this.setState({
          visible: true,
          title: '编辑'
        }, function () {
          if (res.wisdomseeProjectId != "") {
            _this2.child.getProjectInfoById(res.wisdomseeProjectId);
          }
        });
      });
    };
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this2.store.pageIndex = 1;
                _this2.store.pageSize = pageSize;
                _this2.getTableData();
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _this2.store.pageIndex = pageNumber;
                _this2.getTableData();
    ...
    _this2.convertState2String = function (type) {
      if (type === 1) return "在建";
      if (type === 2) return "维护";
    };
    ...
    _this2.store = new _ConstructionStore2.default();
    _this2.state = {
      selectedRowKeys: [],
      loading: false,
      visible: false,
  ...
  _createClass(Construction, [{
    ...
    value: function componentDidMount() {
      this.getTableData();
      this.store.getProjectZPlanList();
    }
  }, {
    ...
    value: function render() {
      ...
      var columns = [{
        ...
        render: function render(text, record) {
          return _react2.default.createElement(
            'a',
            {
              ...
              href: 'javascript:;', onClick: _this4.handleEdit.bind(_this4, record.id) },
            text
          );
        },
        align: 'center'
        ...
        title: '施工单位',
        dataIndex: 'constructionUnits',
        key: 'constructionUnits',
        render: function render(text, record) {
          return _react2.default.createElement(
            'div',
            { style: {
        ...
        render: function render(text, record) {
          return _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              { style: { color: '#1890ff' }, className: 'pointer', to: "/schedule?projectId=" + record.id + "&name=" + encodeURI(record.name) },
              '\u6392\u671F'
            ),
            _react2.default.createElement(_antd.Divider, { type: 'vertical' }),
            _react2.default.createElement(
              _reactRouterDom.Link,
              { style: { color: '#1890ff' }, className: 'pointer', to: "/xmgl?projectId=" + record.id + "&name=" + encodeURI(record.name) },
              '\u65E5\u5FD7'
            ),
            _react2.default.createElement(_antd.Divider, { type: 'vertical' }),
            _react2.default.createElement(
              _reactRouterDom.Link,
              { style: { color: '#1890ff' }, className: 'pointer', to: "/weeknews?projectId=" + record.id + "&name=" + encodeURI(record.name) },
              '\u5468\u62A5'
            )
          );
        }
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          _antd.Button,
          { style: { margin: '0 0 10px 0' }, type: 'primary', onClick: this.handleAdd },
          '\u65B0\u589E'
        ),
        _react2.default.createElement(_antd.Divider, { type: 'vertical' }),
        _react2.default.createElement(
          _antd.Button,
          { style: { margin: '0 0 10px 0' }, type: 'danger', onClick: this.showDeleteConfirm.bind(this) },
          '\u5220\u9664'
        ),
        ...
        _react2.default.createElement(_AddOrEdit2.default, {
          visible: visible,
          title: title,
...
var AddOrEdit = (0, _mobxReact.observer)(_class = function (_React$Component) {
	_inherits(AddOrEdit, _React$Component);

	function AddOrEdit(props) {
		var _this2 = this;

		_classCallCheck(this, AddOrEdit);

		var _this = _possibleConstructorReturn(this, (AddOrEdit.__proto__ || Object.getPrototypeOf(AddOrEdit)).call(this, props));

		_this.convertProjectState2Int = function (type) {
			if (type === "在建") return 1;
			if (type === "维护") return 2;
			if (type === "停工") return 3;
		};

		_this.handleInputNumberChage = function (type, number) {
			_this.store.projectField[type] = number;
		};
			...
			fetch('https://restapi.amap.com/v3/geocode/geo?key=08cde7c6ec084c2b876f82636820b573&address=' + param, {
				...
				if (res.ok) {
					res.json().then(function (data) {
						...
						_this.store.projectField = Object.assign(mobx.toJS(_this.store.projectField), {
		...
		_this.handleSubmit = function (e) {
			...
			_this.props.form.validateFields(function (err, values) {
				if (!err) {
					_this.store.projectField['buildUnits'] = Object.assign(_this.store.projectField['buildUnits'], { orgUser: _this.store['buildUnits'] });
					_this.store.projectField['supervisionUnits'] = Object.assign(_this.store.projectField['supervisionUnits'], { orgUser: _this.store['supervisionUnits'] });
					_this.store.projectField['constructionUnits'] = Object.assign(_this.store.projectField['constructionUnits'], { orgUser: _this.store['constructionUnits'] });
					//this.store.projectField['state'] = this.convertProjectState2Int(this.store.projectField['state']);
					_this.store.projectField['requiredTime'] = (0, _moment2.default)(_this.store.projectField['requiredTime']).valueOf();
					_this.store.saveProject().then(function (res) {
						if (res.code == 0) {
							...
							_this.handleCancel();
							_this.store.pageIndex = 1;
							_this.store.pageSize = 20;
							_this.props.getTableData();
						}
					});
				}
			});
		...
		_this.handleCancel = function () {
			_this.props.updateState('visible', false);
			_this.store.buildUnits = Object.assign([]);
			_this.store.supervisionUnits = Object.assign([]);
			_this.store.constructionUnits = Object.assign([]);
			_this.store.projectField = Object.assign({}, {
				id: null,
				name: '',
				code: '',
				region: '',
		...
		_this.onchange = function (type, e) {
			_this.store.projectField[type] = Object.assign(_this.store.projectField[type], { name: e.target.value });
		};

		_this.handChange = function (type, e) {
			_this.store.projectField[type] = e.target.value;
		};

		_this.handNumber = function (type, value) {
			_this.store.projectField[type] = value;
		};
			...
			var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(type, value) {
				...
				return regeneratorRuntime.wrap(function _callee$(_context) {
					while (1) {
						switch (_context.prev = _context.next) {
							case 0:
								_this.store.projectField[type] = Object.assign([], value);
		...
		_this.remove = function (type, index) {
			var customList = JSON.parse(JSON.stringify(_this.store[type]));
			var list = (0, _immutable.List)(customList);
			_this.store[type] = Object.assign([], list.delete(index).toJS());
			_this.props.form.resetFields();
		};

		_this.add = function (type) {
			var customList = JSON.parse(JSON.stringify(_this.store[type]));
			_this.store[type] = [].concat(_toConsumableArray(customList), [{ userId: '', userName: '', position: '' }]);
			_this.props.form.resetFields();
		};

		_this.onSelChange = function (type, index, value, e) {
			_this.props.form.resetFields();
			var newVal = e.props.val;
			var customList = JSON.parse(JSON.stringify(_this.store[type]));
			var list = (0, _immutable.List)(customList);
			list.update(index, function (val) {
				val.position = customList[index].position;
				val.userId = newVal.id;
				val.userName = newVal.realname;
				return val;
			});
			_this.store[type] = Object.assign([], list.toJS());
		};

		_this.handleChange = function (type, index, value) {
			_this.props.form.resetFields();
			var customList = JSON.parse(JSON.stringify(_this.store[type]));
			var list = (0, _immutable.List)(customList);
			list.update(index, function (val) {
				val.position = value;
				val.userId = customList[index].userId;
				val.userName = customList[index].userName;
				return val;
			});
			_this.store[type] = Object.assign([], list.toJS());
		};

		_this.handleChangeState = function (type, e) {
			//问题状态的修改
			_this.store.projectField[type] = e.target.value;
		};

		_this.onDateChange = function (type, value, dateString) {
			_this.store.projectField[type] = dateString;
		};

		_this.handleAdd = function (type) {
			var customList = JSON.parse(JSON.stringify(_this.store.projectField[type]));
			if (customList.some(function (item) {
				return item.name == "" || item.name == null;
			})) {
				_antd.message.warn("请填写分包单位");
				return false;
			}
			_this.store.projectField[type] = [].concat(_toConsumableArray(customList), [{
				"id": null,
				"name": "",
				"ogranCode": "",
				"type": 1,
		...
		_this.handleFenbao = function (type, index) {
			var customList = JSON.parse(JSON.stringify(_this.store.projectField[type]));
			customList[index].orgUser = [].concat(_toConsumableArray(customList[index].orgUser), [{ userId: '', userName: '', position: '' }]);
			_this.store.projectField[type] = Object.assign([], customList);
			_this.props.form.resetFields();
		};

		_this.removeFenbao = function (type, index, vindex) {
			var customList = JSON.parse(JSON.stringify(_this.store.projectField[type]));
			var list = (0, _immutable.List)(customList[index].orgUser);
			customList[index].orgUser = Object.assign([], list.delete(index).toJS());
			_this.store.projectField[type] = Object.assign([], customList);
			_this.props.form.resetFields();
		};

		_this.onFenbaochange = function (type, index, e) {
			var customList = JSON.parse(JSON.stringify(_this.store.projectField[type]));
			customList[index].name = e.target.value;
			_this.store.projectField[type] = Object.assign([], customList);
			_this.props.form.resetFields();
		};

		_this.handlefenbaoChange = function (type, index, vindex, value) {
			//console.log(type, index, vindex, value, '变化')

			//this.props.form.resetFields();
			var customList = JSON.parse(JSON.stringify(_this.store.projectField[type]));
			var list = (0, _immutable.List)(customList[index].orgUser);
			list.update(vindex, function (val) {
				val.position = value;
				val.userId = customList[index].orgUser[vindex].userId;
				val.userName = customList[index].orgUser[vindex].userName;
				return val;
			});
			customList[index].orgUser = Object.assign([], list.toJS());
			_this.store.projectField[type] = Object.assign([], customList);
			_this.props.form.resetFields();
			//console.log(JSON.parse(JSON.stringify(this.store.projectField[type])), '变化1')
		};

		_this.onfenbaoSelChange = function (type, index, vindex, value, e) {
			//console.log(type, index, vindex, value, e, '888')

			var newVal = e.props.val;
			var customList = JSON.parse(JSON.stringify(_this.store.projectField[type]));
			var list = (0, _immutable.List)(customList[index].orgUser);
			list.update(vindex, function (val) {
				val.position = customList[index].orgUser[vindex].position;
				val.userId = newVal.id;
				val.userName = newVal.realname;
				return val;
			});
			...
			_this.store.projectField[type] = Object.assign([], customList);
			_this.props.form.resetFields();
			//	console.log(JSON.parse(JSON.stringify(this.store.projectField[type])), '变化2')
		};

		_this.removeFen = function (type, index) {
			var customList = JSON.parse(JSON.stringify(_this.store.projectField[type]));
			var list = (0, _immutable.List)(customList);
			_this.store.projectField[type] = Object.assign([], list.delete(index).toJS());
			//console.log( JSON.parse(JSON.stringify(this.store.projectField[type])), '变化2')
		...
		_this.checkPeopleCount = function (rule, value, callback) {
			if (value > 0) {
				callback();
				return;
			} else {
		...
		_this.handleAddPosition = function (type) {
			var customList = JSON.parse(JSON.stringify(_this.store.projectField[type]));
			if (customList.some(function (item) {
				return item.name == "" || item.name == null;
			})) {
				_antd.message.warn("请填写位置点名称");
				return false;
			}
			_this.store.projectField[type] = [].concat(_toConsumableArray(customList), [{
				"id": null,
				"name": "",
				"projectId": _this.store.projectField.id
			}]);
			_this.props.form.resetFields();
		};

		_this.zplanChange = function (value, e) {
			var val = e.props.val;

			_this.store.projectField['zplan'] = Object.assign({}, val);
		};

		_this.onPosChange = function (type, index, e) {
			var customList = JSON.parse(JSON.stringify(_this.store.projectField[type]));
			customList[index].name = e.target.value;
			_this.store.projectField[type] = Object.assign([], customList);
		};
		...
		_this.companyScroll = function (e) {
			...
			if (target.scrollTop + target.offsetHeight === target.scrollHeight) {
				...
				_this.setState({
					...
					_this.store.getAllProjectList(params).then(function (res) {
						_this.setState({
		...
		_this.fetchCompany = function (value) {
			_this.setState({ companyData: [], fetching: true, text: value, pageIndex: 1 }, function () {
		...
		_this.getCompanyList = function () {
			...
			_this.store.getAllProjectList(params).then(function (res) {
				_this.setState({
					companyData: Object.assign([], typeof res.body !== "undefined" ? res.body : [])
				});
			});
		};

		_this.setCheckNum = function (val, e) {
			_this.store.projectField['wisdomseeProjectId'] = val;
		};

		_this.getProjectInfoById = function (param) {
			_this.store.getProjectInfoById(param).then(function (res) {
				if (res) {
					_this.setState({
						companyData: [{
							id: param,
		...
		_this.state = {
			state: ['在建', '维护'], //项目状态1在建2完工3停工
			itemState: [{ id: 1, name: '在建' }, { id: 2, name: '维护' }],
			buildUnits: [], // 建设单位
			supervisionUnits: [], // 施工单位
			constructionUnits: [], // 监理单位
			pos: ['负责人', '专业质检员', '专业工程师', '专业工长', '检验员'], // 岗位
			fetching: false,
			text: "", //关键字
			pageIndex: 1,
			companyData: []
	...
	_createClass(AddOrEdit, [{
		...
		value: function render() {
			...
			var formItems = mobx.toJS(this.store.buildUnits).length && mobx.toJS(this.store.buildUnits).map(function (item, index) {
				return _react2.default.createElement(
					_antd.Row,
					{ key: 'buildUnits' + index },
					_react2.default.createElement(
						_antd.Col,
						{ span: 12 },
						_react2.default.createElement(
							...
							getFieldDecorator("position" + index, {
								...
								rules: [{
									required: mobx.toJS(_this4.store.buildUnits).length ? true : false,
									message: "请输入岗位名称"
								}]
							})(_react2.default.createElement(
								_antd.Select,
								{
									value: item.position,
									onChange: _this4.handleChange.bind(_this4, "buildUnits", index) },
								_this4.state.pos.map(function (vitem, vindex) {
									return _react2.default.createElement(
										Option,
										{ key: 'pos' + vindex, value: vitem },
										vitem
									);
								})
							))
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							getFieldDecorator("userName" + index, {
								...
								onChange: _this4.onSelChange.bind(_this4, 'buildUnits', index),
								value: item.userName,
							...
							_react2.default.createElement(_antd.Button, {
								...
								onClick: _this4.remove.bind(_this4, "buildUnits", index),
								size: 'small',
								icon: 'minus',
								type: 'default' })
						)
			...
			var formItems2 = mobx.toJS(this.store.supervisionUnits).length && mobx.toJS(this.store.supervisionUnits).map(function (item, index) {
				return _react2.default.createElement(
					_antd.Row,
					{ key: 'supervisionUnits' + index },
					_react2.default.createElement(
						_antd.Col,
						{ span: 12 },
						_react2.default.createElement(
							...
							getFieldDecorator("position2" + index, {
								initialValue: item.position || "",
								rules: [{
									required: mobx.toJS(_this4.store.supervisionUnits).length ? true : false,
									message: "请输入岗位名称"
								}]
							})(_react2.default.createElement(
								_antd.Select,
								{
									value: item.position,
									onChange: _this4.handleChange.bind(_this4, 'supervisionUnits', index) },
								_this4.state.pos.map(function (vitem, vindex) {
									return _react2.default.createElement(
										Option,
										{ key: 'pos' + vindex, value: vitem },
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							getFieldDecorator("userName2" + index, {
								initialValue: item.userName || "",
								rules: [{
									required: mobx.toJS(_this4.store.supervisionUnits).length ? true : false,
									message: "请输入姓名"
								...
								type: 'userid',
								url: _config2.default.authorization.getUserInfoListByRoleCode,
								onChange: _this4.onSelChange.bind(_this4, 'supervisionUnits', index),
								value: item.userName,
								query: _authorization2.default.authorization.getUserInfoListByRoleCode
							})),
							_react2.default.createElement(_antd.Button, {
								shape: 'circle',
								className: 'dynamic-delete-button2',
								onClick: _this4.remove.bind(_this4, "supervisionUnits", index),
								size: 'small',
								icon: 'minus',
								type: 'default' })
						)
			...
			var formItems3 = mobx.toJS(this.store.constructionUnits).length && mobx.toJS(this.store.constructionUnits).map(function (item, index) {
				return _react2.default.createElement(
					_antd.Row,
					{ key: 'constructionUnits' + index },
					_react2.default.createElement(
						_antd.Col,
						{ span: 12 },
						_react2.default.createElement(
							...
							getFieldDecorator("position3" + index, {
								initialValue: item.position || "",
								rules: [{
									required: mobx.toJS(_this4.store.constructionUnits).length ? true : false,
									message: "请输入岗位名称"
								}]
							})(_react2.default.createElement(
								_antd.Select,
								{
									value: item.position,
									onChange: _this4.handleChange.bind(_this4, 'constructionUnits', index) },
								_this4.state.pos.map(function (vitem, vindex) {
									return _react2.default.createElement(
										Option,
										{ key: 'pos' + vindex, value: vitem },
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							getFieldDecorator("userName3" + index, {
								initialValue: item.userName || "",
								rules: [{
									required: mobx.toJS(_this4.store.constructionUnits).length ? true : false,
									message: "请输入姓名"
								...
								type: 'userid',
								url: _config2.default.authorization.getUserInfoListByRoleCode,
								onChange: _this4.onSelChange.bind(_this4, 'constructionUnits', index),
								value: item.userName,
								query: _authorization2.default.authorization.getUserInfoListByRoleCode
							})),
							_react2.default.createElement(_antd.Button, {
								shape: 'circle',
								className: 'dynamic-delete-button2',
								onClick: _this4.remove.bind(_this4, "constructionUnits", index),
								size: 'small',
								icon: 'minus',
								type: 'default' })
						)
			...
			var fileds = mobx.toJS(this.store.projectField);

			return _react2.default.createElement(
				_antd.Modal,
				{
					title: this.props.title + "项目",
					width: '60%',
					style: { minWidth: '800px', top: 20 },
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								getFieldDecorator('name', {
									initialValue: fileds.name,
									rules: [{
										required: true,
										message: '请输入项目名称'
									}]
								})(_react2.default.createElement(_antd.Input, { placeholder: '\u8BF7\u8F93\u5165',
									onChange: this.handChange.bind(this, "name") }))
							)
						),
						_react2.default.createElement(
							_antd.Col,
							...
							_react2.default.createElement(
								_antd.Form.Item,
								{
									label: _react2.default.createElement(
										...
										null,
										'\u9879\u76EE\u7F16\u53F7\xA0',
										_react2.default.createElement(_antd.Icon, { type: 'question-circle-o', title: '\u9879\u76EE\u7F16\u53F7\u4FDD\u5B58\u4E4B\u540E\u81EA\u52A8\u751F\u6210' })
									) },
								getFieldDecorator('code', {
									initialValue: fileds.code,
									rules: [{
										required: false,
										message: '请输入项目编号'
									}]
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								getFieldDecorator('region', {
									initialValue: fileds.region == null ? [] : mobx.toJS(fileds.region),
									rules: [{
										required: true,
										message: '请输入项目地址'
									}]
									...
									_react2.default.createElement(_antd.Cascader, {
										...
										value: fileds.region == null ? [] : mobx.toJS(fileds.region),
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(_antd.Input, { placeholder: '\u8BE6\u7EC6\u5730\u5740',
									value: fileds.address,
									onChange: this.handChange.bind(this, "address") })
							)
						),
						_react2.default.createElement(
							_antd.Col,
							...
							_react2.default.createElement(
								_antd.Form.Item,
								{ label: '\u5173\u8054\u6591\u9A6C' },
								getFieldDecorator('zplan', {
									initialValue: fileds.zplan == null ? "" : _typeof(fileds.zplan) == 'object' ? mobx.toJS(fileds.zplan).name : "",
									rules: [{
										required: false,
										message: '请选择'
									}]
									...
									_antd.Select,
									{
										...
										onChange: this.zplanChange,
										filterOption: function filterOption(input, option) {
											return option.props.children.toLowerCase().indexOf(input.toLowerCase()) >= 0;
										}
									},
									mobx.toJS(this.store.ZPlanList).map(function (item, index) {
										return _react2.default.createElement(
											Option,
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									...
									getFieldDecorator('wisdomseeProjectId', {
										initialValue: fileds.wisdomseeProjectId == null ? "" : fileds.wisdomseeProjectId,
										rules: [{
											required: false,
											message: '请选择'
										}]
										...
										companyData && companyData.map(function (item) {
											return _react2.default.createElement(
												Option,
												{ value: item.id, key: item.id, title: item.name },
												item.name
											);
										})
									))
					...
					_react2.default.createElement(_antd.Divider, { dashed: true, style: { margin: '10px 0' } }),
					_react2.default.createElement(
						_antd.Row,
						null,
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								getFieldDecorator('state', {
									...
									_react2.default.createElement(
										RadioGroup,
										{ onChange: this.handleChangeState.bind(this, "state"),
											value: fileds.state },
										itemState.map(function (item, index) {
											return _react2.default.createElement(
												_antd.Radio,
												{ key: 'state' + index, value: item.id },
												item.name
											);
										})
									)
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								getFieldDecorator('requiredTime', {
									initialValue: fileds.requiredTime == null ? "" : (0, _moment2.default)(fileds.requiredTime),
									rules: [{
										required: true,
										message: '请输入交付日期'
									}]
									...
									format: 'YYYY-MM-DD',
									style: { width: '100%' },
									value: fileds.requiredTime == null ? "" : (0, _moment2.default)(fileds.requiredTime),
									onChange: this.onDateChange.bind(this, 'requiredTime')
								}))
							)
						),
						fileds.state === "维护" ? _react2.default.createElement(
							_antd.Col,
							{ span: 12 },
							_react2.default.createElement(
								_antd.Form.Item,
								...
								getFieldDecorator('peopleCount', {
									initialValue: fileds.peopleCount,
									rules: [{ required: true }, { validator: this.checkPeopleCount }]
								})(_react2.default.createElement(_antd.InputNumber, {
									style: { width: '100%' },
									min: 0,
									onChange: this.handleInputNumberChage.bind(this, "peopleCount"),
									formatter: this.limitDecimals,
									parser: this.limitDecimals }))
							)
						) : ""
					),
					mobx.toJS(this.store.projectField.positions).map(function (item, index) {
						return _react2.default.createElement(
							'div',
							{ key: 'positions' + index },
							_react2.default.createElement(
								...
								_react2.default.createElement(
									...
									_react2.default.createElement(
										...
										getFieldDecorator('positions+' + index, {
											...
											onChange: _this4.onPosChange.bind(_this4, "positions", index)
										})),
										_react2.default.createElement(_antd.Button, {
											shape: 'circle',
											className: 'dynamic-delete-button2',
											onClick: _this4.removeFen.bind(_this4, "positions", index),
											size: 'small',
											icon: 'minus',
											type: 'default' })
									)
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							_antd.Button,
							{ type: 'dashed', onClick: this.handleAddPosition.bind(this, 'positions') },
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								getFieldDecorator('buildUnits', {
									initialValue: fileds.buildUnits == null ? "" : fileds.buildUnits.name,
									rules: [{
										required: true,
										message: '请输入建设单位'
									}]
								})(_react2.default.createElement(_antd.Input, { placeholder: '\u8BF7\u8F93\u5165',
									value: fileds.buildUnits == null ? "" : fileds.buildUnits.name,
									onChange: this.onchange.bind(this, "buildUnits") }))
							)
						)
					),
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							_antd.Button,
							{ type: 'dashed', onClick: this.add.bind(this, 'buildUnits') },
							_react2.default.createElement(_antd.Icon, { type: 'plus' }),
							' \u6DFB\u52A0\u5EFA\u8BBE\u5355\u4F4D\u6210\u5458'
						)
					),
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								_antd.Form.Item,
								{ label: '\u65BD\u5DE5\u5355\u4F4D' },
								getFieldDecorator('constructionUnits', {
									initialValue: fileds.constructionUnits == null ? "" : fileds.constructionUnits.name,
									rules: [{
										required: true,
										message: '请输入施工单位'
									}]
								})(_react2.default.createElement(_antd.Input, { placeholder: '\u8BF7\u8F93\u5165',
									value: fileds.constructionUnits == null ? "" : fileds.constructionUnits.name,
									onChange: this.onchange.bind(this, "constructionUnits") }))
							)
						)
					),
					formItems3 ? formItems3 : null,
					_react2.default.createElement(
						_antd.Form.Item,
						formItemLayoutWithOutLabel,
						_react2.default.createElement(
							_antd.Button,
							{ type: 'dashed', onClick: this.add.bind(this, 'constructionUnits') },
							_react2.default.createElement(_antd.Icon, { type: 'plus' }),
							' \u6DFB\u52A0\u65BD\u5DE5\u5355\u4F4D\u6210\u5458'
						)
					),
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								_antd.Form.Item,
								{ label: '\u76D1\u7406\u5355\u4F4D' },
								getFieldDecorator('supervisionUnits', {
									initialValue: fileds.supervisionUnits == null ? "" : fileds.supervisionUnits.name,
									rules: [{
										required: true,
										message: '请输入监理单位'
									}]
								})(_react2.default.createElement(_antd.Input, { placeholder: '\u8BF7\u8F93\u5165',
									value: fileds.supervisionUnits == null ? "" : fileds.supervisionUnits.name,
									onChange: this.onchange.bind(this, "supervisionUnits") }))
							)
						)
					),
					formItems2 ? formItems2 : null,
					_react2.default.createElement(
						_antd.Form.Item,
						formItemLayoutWithOutLabel,
						_react2.default.createElement(
							_antd.Button,
							{ type: 'dashed', onClick: this.add.bind(this, 'supervisionUnits') },
							_react2.default.createElement(_antd.Icon, { type: 'plus' }),
							' \u6DFB\u52A0\u76D1\u7406\u5355\u4F4D\u6210\u5458'
						)
					),
					_react2.default.createElement(_antd.Divider, { dashed: true, style: { margin: '10px 0' } }),
					mobx.toJS(this.store.projectField.subcontractors).map(function (item, index) {
						return _react2.default.createElement(
							'div',
							{ key: 'sub' + index },
							_react2.default.createElement(
								...
								_react2.default.createElement(
									...
									_react2.default.createElement(
										_antd.Form.Item,
										{ label: '\u5206\u5305\u5355\u4F4D' },
										getFieldDecorator('subname+' + index, {
											initialValue: item.name == null ? "" : item.name,
											rules: [{
												required: true,
												message: '请输入分包单位'
											...
											value: item.name == null ? "" : item.name,
											onChange: _this4.onFenbaochange.bind(_this4, "subcontractors", index) })),
										_react2.default.createElement(_antd.Button, {
											shape: 'circle',
											className: 'dynamic-delete-button2',
											onClick: _this4.removeFen.bind(_this4, "subcontractors", index),
											size: 'small',
											icon: 'minus',
											type: 'default' })
									)
							...
							mobx.toJS(item.orgUser == null ? [] : item.orgUser).map(function (vitem, vindex) {
								return _react2.default.createElement(
									_antd.Row,
									{ key: 'subname+' + index + 'subcontractors' + vindex },
									_react2.default.createElement(
										_antd.Col,
										{ span: 12 },
										_react2.default.createElement(
											...
											getFieldDecorator('subname+' + index + 'subcontractors' + vindex, {
												initialValue: vitem.position || "",
												rules: [{
													//required: item.orgUser.length?true:false,
													required: false,
													message: "请输入岗位名称"
												}]
											})(_react2.default.createElement(
												_antd.Select,
												{
													value: vitem.position,
													onChange: _this4.handlefenbaoChange.bind(_this4, "subcontractors", index, vindex) },
												_this4.state.pos.map(function (vitem, vindex) {
													return _react2.default.createElement(
														Option,
														{ key: 'subcontra' + vindex,
															value: vitem },
														vitem
													);
												})
									...
									_react2.default.createElement(
										...
										_react2.default.createElement(
											...
											getFieldDecorator('subname+' + index + "subcontractors3" + vindex, {
												initialValue: vitem.userName || "",
												rules: [{
													//required: item.orgUser.length?true:false,
													required: false,
													message: "请输入姓名"
												...
												type: 'userid',
												url: _config2.default.authorization.getUserInfoListByRoleCode,
												onChange: _this4.onfenbaoSelChange.bind(_this4, "subcontractors", index, vindex),
												value: vitem.userName,
												query: _authorization2.default.authorization.getUserInfoListByRoleCode
											})),
											_react2.default.createElement(_antd.Button, {
												shape: 'circle',
												className: 'dynamic-delete-button2',
												onClick: _this4.removeFenbao.bind(_this4, "subcontractors", index, vindex),
												size: 'small',
												icon: 'minus',
												type: 'default' })
										)
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									_antd.Button,
									{ type: 'dashed',
										onClick: _this4.handleFenbao.bind(_this4, 'subcontractors', index) },
									_react2.default.createElement(_antd.Icon, { type: 'plus' }),
									' \u6DFB\u52A0\u5206\u5305\u5355\u4F4D\u6210\u5458'
								)
							)
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							_antd.Button,
							{ type: 'primary', onClick: this.handleAdd.bind(this, 'subcontractors') },
							_react2.default.createElement(_antd.Icon, { type: 'plus' }),
							' \u6DFB\u52A0\u5206\u5305\u5355\u4F4D'
						)
					)
...
var AddOrEditForm = _antd.Form.create({})(AddOrEdit);
exports.default = AddOrEditForm;

/***/ })

});
//# sourceMappingURL=32-afa7d4b4bae6ff2924e9.1629092961041.js.map