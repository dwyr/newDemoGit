...
var NewProject = (_dec = (0, _mobxReact.inject)('DeliveryStore'), _dec2 = _antd.Form.create(), _dec(_class = (0, _reactRouterDom.withRouter)(_class = _dec2(_class = (0, _mobxReact.observer)(_class = function (_React$Component) {
	...
	function NewProject(props) {
		...
		_this.handleChange = function (type, field, index, e) {
			var value = typeof e.target.type == "text" ? e.target.value : e.target.value;
			var customList = JSON.parse(JSON.stringify(_this.store.salesObj[type]));
			...
			if (field == "channelType" && value == "全高闸") {
				...
				_this.props.form.setFieldsValue(_defineProperty({}, "safetyDoor" + index, "是"));
			} else {
				list.update(index, function (val) {
					val[field] = value;
					return val;
			...
			_this.store.salesObj[type] = Object.assign([], list.toJS());
		};

		_this.handleSubmit = function (e) {
			e.preventDefault();

			var salesObj = JSON.parse(JSON.stringify(_this.store.salesObj));
			// 照片校验
				...
				if (!err) {
					...
					_this.store.saveSalesOrder({
						...
						if (res) {
							...
							// 更新数据
							_this.store.salesObj = Object.assign({}, res);
						}
					});
				}
			});
		...
		_this.handleAttment = function (type, params) {
			...
			// let obj = JSON.parse(JSON.stringify(this.store.salesObj["constructionConditions"]));
			// obj["atts"] = Object.assign([], arr);
			// this.store.salesObj["constructionConditions"] = Object.assign({}, obj);
		};
		...
		_this.createProjectStep1 = function () {
			var projectObj = _this.store.projectObj;
			...
			_this.props.form.validateFields(function (err, values) {
				if (!err) {
					delete values.name;
					_this.store.projectObj = Object.assign(projectObj, values, {
						"beginTime": values['beginTime'] === '' ? 0 : values['beginTime'].valueOf(),
						"endTime": values['endTime'] === '' ? 0 : values['endTime'].valueOf(),
						//"tempBuildBeginTime":values['tempBuildBeginTime']===''?0:values['tempBuildBeginTime'].valueOf(),
						//"tempBuildEndTime":values['tempBuildEndTime']===''?0:values['tempBuildEndTime'].valueOf(),
						"mainPhoto": attachments.length > 0 ? attachments[0]['url'] : null
					});
		...
		_this.finishCreateProject = function () {
			var projectObj = _this.store.projectObj;
			var selectedSubProjects = _this.state.selectedSubProjects;

			var _mobx$toJS = mobx.toJS(projectObj),
			    masters = _mobx$toJS.masters,
			    id = _mobx$toJS.id,
			    number = _mobx$toJS.number,
			    createUserId = _mobx$toJS.createUserId,
			    createUserName = _mobx$toJS.createUserName,
			    createTime = _mobx$toJS.createTime,
			    updateTime = _mobx$toJS.updateTime,
			    newProject = _objectWithoutProperties(_mobx$toJS, ['masters', 'id', 'number', 'createUserId', 'createUserName', 'createTime', 'updateTime']);

			_this.store.addProject({ "dictId": "" }).then(function (res) {
				if (res) {
					_this.store.updateProject({ "p": Object.assign(res, newProject) }).then(function (res) {
						if (res) {
							_this.store.projectObj = Object.assign({}, res);
							// if(selectedSubProjects.length>0){
							// 	const sspList = selectedSubProjects.map((item, index)=>{
							// 		return Object.assign({},{
							// 			"parent":res.id,
							// 			"name":item.name,
							// 			"masterId":item.masters[0]['userId'],
							// 			"masterName":item.masters[0]['userName']
							// 		})
							// 	})
							// 	sspList.forEach((item)=>{
							// 		this.store.addChildProject(item)
							// 	})
							// }
							// this.setCreateStep(2);
							_this.goToLink('/delivery');
							// this.store.getSubProjectList({"parentId": res.id, "pageIndex": "1", "pageSize": "100"}).then((res)=>{
							// 	this.setState({subProjectList:res})
							// })
						}
					});
				}
		...
		_this.selectedSubProject = function (selectedRows) {
			_this.setState({
				selectedSubProjects: selectedRows
			});
		};
	...
	_createClass(NewProject, [{
		...
		value: function render() {
			...
			var _state = this.state,
			    ...
			    subProjects = _state.subProjects,
			    createStep = _state.createStep,
			    subProjectList = _state.subProjectList,
			    mainPhoto = _state.mainPhoto,
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ className: 'mt30', style: { display: 'none', justifyContent: 'center' } },
					_react2.default.createElement(
						_antd.Steps,
						{ current: createStep, style: { width: '600px' } },
						_react2.default.createElement(Step, { title: '\u9879\u76EE\u57FA\u672C\u4FE1\u606F', description: '\u9879\u76EE\u57FA\u672C\u4FE1\u606F' }),
						_react2.default.createElement(Step, { title: '\u5B8C\u6210', description: '\u5B8C\u6210' })
					)
				),
				_react2.default.createElement(
					'div',
					{ style: createStep === 0 ? { display: '' } : { display: 'none' }, className: 'mt30' },
					_react2.default.createElement(
						_antd.Form,
									...
									_react2.default.createElement(
										...
										_react2.default.createElement(
											...
											getFieldDecorator('region', {
												initialValue: fields.region || "",
												rules: [{ required: true, message: '此项是必填' }]
											})(_react2.default.createElement(_antd.Cascader, {
												placeholder: '\u7701/\u5E02/\u533A(\u53BF)',
												showSearch: this.filter,
												options: _cityData2.default,
												value: fields.region == null ? [] : mobx.toJS(fields.region),
				...
				_react2.default.createElement(
					'div',
					{ style: createStep === 1 ? { display: '' } : { display: 'none' }, className: 'mt30' },
					_react2.default.createElement(
						'div',
						{ className: 'mt30', style: { display: 'flex' } },
						_react2.default.createElement(
							_antd.Button,
							{
								className: 'fl',
					...
					_react2.default.createElement(
						'div',
						{ className: 'mt30' },
						_react2.default.createElement(_EditableTableSubProject2.default, {
							id: 'id',
							store: this.store,
							dataSource: subProjects,
							selectedRows: this.selectedSubProject,
				...
				_react2.default.createElement(
					'div',
					{ style: createStep === 2 ? { display: '' } : { display: 'none' }, className: 'mt30' },
					_react2.default.createElement(
						'div',
						{ style: { display: 'flex', flexDirection: 'column' } },
						_react2.default.createElement(
							'div',
							{ className: 'delivery-project-info' },
							_react2.default.createElement(
								'div',
								...
								_react2.default.createElement(
									'div',
									{ className: 'project-userinfo mt15' },
									projectObj.masterName
								)
							)
						),
						_react2.default.createElement(
							'div',
							{ className: 'delivery-subproject-info' },
							_react2.default.createElement(
								_antd.Row,
								{ gutter: [{ xs: 24, sm: 24, md: 24, lg: 24, xl: 24 }, 15] },
								subProjectList.map(function (item, index) {
									return _react2.default.createElement(
										_antd.Col,
										{ xs: 24, sm: 24, md: 16, lg: 6, xl: 6, style: { padding: 0 } },
										_react2.default.createElement(
											'div',
											{ style: { display: 'flex', flexDirection: 'column', justifyContent: "center", alignItems: 'center' } },
											_react2.default.createElement(
												'div',
												{ className: 'sub-project-title' },
												item.name
											),
											_react2.default.createElement(
												'div',
												{ className: 'sub-project-userinfo mt15' },
												item.masterName
											)
										)
									);
				...
				_react2.default.createElement(
					'div',
					{ className: 'clearfix mt30', style: createStep === 0 ? { display: 'flex', justifyContent: 'center' } : { display: 'none' } },
					_react2.default.createElement(
						_antd.Button,
						{ onClick: this.createProjectStep1, style: { backgroundColor: 'rgba(26, 188, 156, 1)', color: '#fff' } },
						'\u5B8C\u6210\u521B\u5EFA'
					)
				),
				_react2.default.createElement(
					'div',
					{ className: 'clearfix mt30', style: createStep === 1 ? { display: 'flex', justifyContent: 'center' } : { display: 'none' } },
					_react2.default.createElement(
						_antd.Button,
						{ onClick: function onClick() {
								_this4.setCreateStep(0);
							}, style: { backgroundColor: 'rgba(26, 188, 156, 1)', color: '#fff' } },
						'\u4E0A\u4E00\u6B65'
					),
					_react2.default.createElement(
						_antd.Button,
						{ onClick: this.finishCreateProject, style: { backgroundColor: 'rgba(26, 188, 156, 1)', color: '#fff' } },
						'\u5B8C\u6210\u65B0\u5EFA'
					)
				),
				_react2.default.createElement(
					'div',
					{ className: 'clearfix mt30', style: createStep === 2 ? { display: 'flex', justifyContent: 'center' } : { display: 'none' } },
					_react2.default.createElement(
						_antd.Button,
						{ onClick: function onClick() {
								_this4.goToLink('/delivery');
							}, style: { backgroundColor: 'rgba(26, 188, 156, 1)', color: '#fff' } },
						'\u8FD4\u56DE\u9879\u76EE\u5217\u8868'
					),
					_react2.default.createElement(
						_antd.Button,
						{ onClick: function onClick() {
								_this4.goToLink('/delivery/keylink?projectId=' + projectObj.id);
							}, style: { backgroundColor: 'rgba(26, 188, 156, 1)', color: '#fff' } },
						'\u8FDB\u5165\u9879\u76EE'
					)
				)
...
//# sourceMappingURL=25-afa7d4b4bae6ff2924e9.1629092961041.js.map