...
var Document = (_dec = (0, _mobxReact.inject)('DeliveryStore'), _dec(_class = (0, _reactRouterDom.withRouter)(_class = (0, _mobxReact.observer)(_class = function (_React$Component) {
    ...
    function Document(props) {
        ...
        _this.getDocumentListByCategory = function () {
            var params = {
                taskId: _this.state.id,
                category: 2
            };
            _this.store.getDocumentListByCategory(params).then(function (res) {
                _this.setState({
                    dataSource: res
                });
            });
        ...
        _this.showModal = function (item) {
            ...
            function getExt(filePath) {
                ...
                var name = filePath.substr(0, index);
                return { name: name, ext: ext };
            }
            _this.setState({
                visible: true,
                item: item,
                value: item.name //getExt(item.name).name,
                //ext: getExt(item.name).ext,
            });
        };
        ...
        _this.handleOk = function () {
            ...
            if (value == null || value == "") {
                _antd.message.warn("名称不能为空");
                return false;
            }
            var obj = JSON.parse(JSON.stringify(item));
            obj.name = value;
            _this.store.updateDocument({ d: obj }).then(function (res) {
                if (res) {
                    _antd.message.success("操作成功");
                    _this.getDocumentListByCategory();
                    _this.setState({
                        visible: false
                    });
                }
        ...
        _this.state = {
            ...
            dataSource: [{
                ...
                isVisible: "",
                downloadCount: "",
                fileUrl: "https://cdn.cnbj1.fds.api.mi-img.com/product-images/mi11/section1-1.jpg",
                fileType: "",
                category: 2
            }, {
                id: 2,
    ...
    _createClass(Document, [{
        ...
        value: function componentDidMount() {
            ...
            var id = _url2.default.parse(search, true).query.taskId;
            this.setState({
                id: id
            }, function () {
                _this2.getDocumentListByCategory();
            });
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            return _react2.default.createElement(
                        ...
                        return _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    _antd.Button,
                                    {
                                        onClick: _this3.showModal.bind(_this3, item),
                                        style: { fontSize: "12px" },
                                        type: 'link' },
                                    '\u91CD\u547D\u540D'
                                )
                ...
                dataSource.length == 0 ? _react2.default.createElement(_antd.Empty, null) : null,
                _react2.default.createElement(
                    _antd.Modal,
                    {
                        title: '\u91CD\u547D\u540D',
...
//# sourceMappingURL=37-afa7d4b4bae6ff2924e9.1629092961041.js.map